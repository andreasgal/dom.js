...
function HTMLParser(domimpl) {
    ...
    function ignoreLinefeed() { ignore_linefeed = true; }
    ...
    function markup_declaration_open_state(c, lookahead, eof) {
        if (lookahead[0] === "-" && lookahead[1] === "-") {
            consume(2);
            beginComment();
            tokenizerState = comment_start_state;
            return;
        }

        if (lookahead.toUpperCase() === "DOCTYPE") {
            consume(7);
            tokenizerState = doctype_state;
        }
        else if (lookahead === "[CDATA[" && cdataAllowed()) {
            consume(7);
            tokenizerState = cdata_section_state;
        }
        else {
            tokenizerState = bogus_comment_state;        
        }
    ...
    function after_doctype_name_state(c, lookahead, eof) {
        ...
        default:  
            ...
            if (lookahead === "PUBLIC") {
                consume(6);
                tokenizerState = after_doctype_public_keyword_state;
            }
            else if (lookahead === "SYSTEM") {
                consume(6);
                tokenizerState = after_doctype_system_keyword_state;
            }
            else {
                forcequirks();
                tokenizerState = bogus_doctype_state;
            }
            break; 
        }
    }
    ...
    function in_head_mode(t, value, arg3, arg4) {
        ...
        insertionMode(t, value, arg3, arg4);   // Then redo this one
    }
    ...
    function in_table_mode(t, value, arg3, arg4) {
        ...
        case TAG:
            ...
            case "table":
                ...
                if (repro) insertionMode(t, value, arg3, arg4);
                return;
    ...
    function in_caption_mode(t, value, arg3, arg4) {
        ...
        case TAG:
            ...
            case "thead":
            case "tr":
                if (end_caption()) insertionMode(t, value, arg3, arg4);
                return;
            }
            break;
        case ENDTAG:
    ...
    function in_row_mode(t, value, arg3, arg4) {
        ...
        case TAG:
            ...
            case "thead":
            case "tr":
                if (endrow()) insertionMode(t, value, arg3, arg4);
                return;
            }
            break;
        case ENDTAG:
    ...
    function in_select_mode(t, value, arg3, arg4) {
        ...
        case ENDTAG:
            ...
            case "optgroup":
                if (stack.top instanceof impl.HTMLOptionElement &&
                    stack.elements[stack.elements.length-2]
                        instanceof impl.HTMLOptGroupElement) {
                    in_select_mode(ENDTAG, "option");
                }
                if (stack.top instanceof impl.HTMLOptGroupElement) 
                    stack.pop();
    ...
    function after_body_mode(t, value, arg3, arg4) {
        ...
        case ENDTAG:
            if (value === "html") {
                if (fragment) return;
                insertionMode = after_after_body_mode;
                return;
            }
            break; // for any other tags
        }
        ...
        case ENDTAG:
            if (value === "frameset") {
                ...
                if (!fragment && !(stack.top instanceof impl.HTMLFrameSetElement))
                    insertionMode = after_frameset_mode;
                return;
            }
            break;
        }
    ...
    function parseCharRef(s) {
        ...
        if (s[0] === "#") {               // Numeric character reference
            ...
            if (s[len-1] === ";")  // If the string ends with a semicolon
                consume(len);      // Consume all the chars
            else
                consume(len-1);    // Otherwise, all but the last character
            ...
            if (s[len-1] === ";") {
                var rv = namedCharRefs[s];
                if (rv !== undefined) {
                    consume(len);  // consume all the characters
                    return rv
                }
            }
            ...
            while(len >= 2) {
                var rv = namedCharRefsNoSemi[s.substring(0, len)];
                if (rv !== undefined) {
                    consume(len);
                    return rv;
                }
