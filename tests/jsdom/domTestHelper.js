...
var domTestHelper = {
    ...
    assertSize : function(descr, expected, actual) {
        var actualSize;
    ...
    assertEqualsAutoCase : function(context, descr, expected, actual) {
    ...
    assertEqualsCollectionAutoCase : function(context, descr, expected, actual) {
        //
    ...
    assertEqualsListAutoCase : function(context, descr, expected, actual) {
    ...
    assertEqualsList : function(test, expected, actual) {
        //
        //  if they aren't the same size, they aren't equal
    ...
    assertInstanceOf : function(descr, type, obj) {
        if(type == "Attr") {
    ...
    assertSame : function(descr, expected, actual) {
        if(expected != actual) {
    ...
    assertURIEquals : function(assertID, scheme, path, host, file, name, query, fragment, isAbsolute, actual) {
        //
    ...
    equalsAutoCase : function(context, expected, actual) {
	if (builder.contentType == "text/html") {
	    if (context == "attribute") {
...
domTestHelper.arrayEqual = domTestHelper.assertEqualsList;