...
//    while(doc.firstChild) doc.removeChild(doc.firstChild);
    ...
    names[1].appendChild(doc.createTextNode("This is a CDATASection with EntityReference number 2 &amp;ent2;This is an adjacent CDATASection with a reference to a tab &amp;tab;"));
    ...
    genders[2].appendChild(doc.createTextNode("&delta;"));//Text("&delta;"));
