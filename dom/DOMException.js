/*
 * Compliance: WebIDL has some weird requirements, and they're weirder
 * in the current editor's draft. (e.g the [[Prototype]] public
 * exception interfaces like DOMException) I probably can't comply with all
 * and I'm not even going to try hard until there is more stability in 
 * the draft. For now, compliance with the existing Mozilla DOM is probably
 * more important.
 */
...
defineLazyProperty(DOM, "DOMException", function() {
    ...
    return implementIDLInterface({
        ...
        init: function DOMException(code) {
            defineReadonlyProperty(this, "code", code);
        },
        members: {
            get name() { return names[this.code]; },
            get message() { return messages[this.code]; }
        },
        constants: {
